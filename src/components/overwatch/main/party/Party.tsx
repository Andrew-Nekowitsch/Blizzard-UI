  ...
  return (
    <>
      <div className="ow-party flex-row">
        <img
          className="search-player float-left"
          src={SearchPlayerImage}
          alt="search for a player"
        ></img>
        <img
          className="add-player float-left"
          src={AddPlayerImage}
          alt="Add player to party"
        ></img>
        <div className="player float-left">
          <img
            src={AnaImage}
            className="player-icon party-square float-left"
            alt="ana"
          ></img>
          <div className="player-name-container flex-column float-left">
            <div className="player-name">ANDREW</div>
            <div className="player-stats flex-row">
              <div className="player-level-outer float-left">
                <div className="player-level-bubble player-level-inner bronze">
                  20
                </div>
              </div>
